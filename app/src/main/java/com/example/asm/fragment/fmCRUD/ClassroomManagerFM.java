...
public class ClassroomManagerFM extends Fragment implements View.OnClickListener {
    ...
    private void setListenerWhenClickOnItemInRecycleView() {
        clickItemInRecyeclerView = new ClickItemInRecyeclerView() {
            @Override
            public void onItemClickInRecycleView(View view, int position) {
                ...
                Toast.makeText(ClassroomManagerFM.this.requireContext(), "" + classID, Toast.LENGTH_SHORT).show();
                Toast.makeText(ClassroomManagerFM.this.requireContext(), "" + className, Toast.LENGTH_SHORT).show();
                Toast.makeText(ClassroomManagerFM.this.requireContext(), "" + iCID, Toast.LENGTH_SHORT).show();
            }
        };
    }
